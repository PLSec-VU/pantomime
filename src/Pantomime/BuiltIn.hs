...
-- provided by 'Embed' is expected to be generated by the symbolic evaluator.
--
-- ```
-- plus :: forall {r} (a :: TYPE r). Embed a (BitVec 64) -> a -> a -> a
-- plus Embed = coerce bvadd
-- ```
--
...
--
data Embed (a :: k1) (b :: k2) where
  Embed :: Coercible a b => Embed a b
